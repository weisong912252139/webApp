...
function fourAnimate() {
	...
	// 给文字添加动态效果
	$('.four .four-word span').eq(0).animate({left:'42%',opacity: 1},2000);
	$('.four .four-word span').eq(1).animate({opacity: 1,transform: 'scale(1)'},2500);
	setTimeout(function (){
		fourAnimatePeople();
	},800)
...
function fourAnimatePeople() {
	...
	setTimeout(function (){
		$('.four-people .circle1').animate({transform: 'scale(1)',left:'108px',top:'76px'},1000);
	},500);
	setTimeout(function (){
		$('.four-people .circle2').animate({left:'235px',top:'135px',transform: 'scale(1)'},1000);
	},800);
	setTimeout(function (){
		$('.four-people .circle3').animate({left:'50px',top:'267px',transform: 'scale(1)'},1000);
	},50);
	setTimeout(function (){
		$('.four-people .circle4').animate({left:'26px',top:'159px',transform: 'scale(1)'},1000);
	},100);
	setTimeout(function (){
		$('.four-people .circle5').animate({left:'246px',top:'366px',transform: 'scale(1)'},1000);
	},1000);
	setTimeout(function (){
		$('.four-people .circle6').animate({left:'225px',top:'258px',transform: 'scale(1)'},1000);
	},700);
	setTimeout(function (){
		$('.four-people .circle7').animate({left:'54px',top:'377px',transform: 'scale(1)'},1000);
	},600);
	setTimeout(function (){
		$('.four-people .circle8').animate({left:'135px',top:'435px',transform: 'scale(1)'},1000);
	},100);
	setTimeout(function () {
	...
	setTimeout(function () {
		$('.four-people .circle12').animate({left:'36.5%',top:'27%',transform: 'scale(1)'},1000);
	},350);
	setTimeout(function () {
...
function sixAnimate() {
	...
	$('.six .six-flag img').eq(1).animate({
		left:'8%',top:'9%',width:'36%',opacity:1,transform: 'scale(1)'
	},1000);
	$('.six .six-flag img').eq(3).animate({
		left:'56%',top:'7%',width:'39.2%',opacity:1,transform: 'scale(1)'
	},1000);
	...
	$('.six .six-flag img').eq(2).animate({
		left:'31%',top:'7%',width:'36%',opacity:1,transform: 'scale(1)'
	},1000);
...
//		$('.seven .snake1').animate({height:height,top:$(window).height() * 0.2 + 'px'},1500);
		...
		$('.seven .snake1 .seven-shadow').animate({top:'150%'},2000);
	},1500);
	setTimeout(function() {
